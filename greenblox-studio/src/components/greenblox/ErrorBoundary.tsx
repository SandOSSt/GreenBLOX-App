...
/**
 * Top-level error boundary for GreenBlox Studio.
 * Catches any unhandled render error and shows a Roblox-style crash screen
 * with a reload button — instead of a blank white page.
 */
...
> {
  ...
  render() {
    ...
    return (
      <div className="grid h-screen w-screen place-items-center bg-[#1a1c24] p-6">
