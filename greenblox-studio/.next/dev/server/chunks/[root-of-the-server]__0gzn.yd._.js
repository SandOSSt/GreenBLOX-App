...
"[project]/greenblox-studio/src/app/api/search/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET(req) {
    ...
    if (!q) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiJson"])({
        results: []
    });
    const like = `%${q.toLowerCase()}%`;
    const res = await __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["pool"].query("SELECT id, name, avatar_color AS \"avatarColor\" FROM users WHERE lower(name) LIKE $1 AND id <> $2 LIMIT 8", [
        like,
        me.id
    ]);
    ...
    const results = (res.rows ?? []).map((r)=>{
        ...
        const inSession = __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$socialStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["socialStore"].getSessionForUser(r.id);
        return {
            id: r.id,
            name: r.name,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0gzn.yd._.js.map