...
"[project]/greenblox-studio/src/app/api/profile/stats/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    const payloads = Array.isArray(body.stats) ? body.stats : body.gameId ? [
        body
    ] : [];
    if (payloads.length === 0) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiJson"])({
        error: "Нет данных"
    }, {
        status: 400
    });
...
//# sourceMappingURL=%5Broot-of-the-server%5D__046j8gw._.js.map