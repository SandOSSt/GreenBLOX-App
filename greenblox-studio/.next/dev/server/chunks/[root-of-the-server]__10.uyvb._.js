...
"[project]/src/social/socialStore.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/greenblox-studio/src/app/api/friends/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$social$2f$socialStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/social/socialStore.ts [app-route] (ecmascript)");
var __turbopack_async_dependencies__ = __turbopack_handle_async_dependencies__([
    __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__,
...
async function GET(req) {
    ...
    const [acceptedA, acceptedB, incomingQ, outgoingQ] = await Promise.all([
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].select().from(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"]).where(and(eq(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"].fromId, me.id), eq(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"].status, "accepted"))),
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].select().from(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"]).where(and(eq(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"].toId, me.id), eq(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"].status, "accepted"))),
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].select().from(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"]).where(and(eq(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"].toId, me.id), eq(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"].status, "pending"))),
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].select().from(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"]).where(and(eq(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"].fromId, me.id), eq(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"].status, "pending")))
    ]);
    const ids = new Set();
    ...
    const liveMap = new Map(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$social$2f$socialStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["socialStore"].snapshot().map((p)=>[
            p.userId,
            p
        ]));
    const friends = [];
    const seen = new Set();
    const pushFriend = (peerId)=>{
        if (seen.has(peerId)) return;
        seen.add(peerId);
        const peer = people.get(peerId);
        if (!peer) return;
        const live = liveMap.get(peerId);
        const session = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$social$2f$socialStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["socialStore"].getSessionForUser(peerId);
        friends.push({
            id: peer.id,
            name: peer.name,
    ...
    const incoming = incomingQ.map((r)=>{
    ...
    const outgoing = outgoingQ.map((r)=>{
...
async function POST(req) {
    ...
    const existing = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].select().from(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"]).where(or(and(eq(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"].fromId, me.id), eq(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"].toId, toId)), and(eq(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"].fromId, toId), eq(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"].toId, me.id)))).limit(1);
    if (existing.length > 0) {
        const e = existing[0];
        if (e.status === "accepted") return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$social$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiJson"])({
            error: "Вы уже друзья"
        }, {
            status: 400
        });
        if (e.fromId === me.id) {
            if (e.status === "pending") return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$social$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiJson"])({
                error: "Заявка уже отправлена"
            }, {
                status: 400
            });
            // Повторная отправка после "declined" — удаляем старую и шлём новую.
            await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].delete(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"]).where(eq(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"].id, e.id));
            const reinserted = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].insert(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"]).values({
                fromId: me.id,
                toId,
                status: "pending"
            }).returning();
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$social$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiJson"])({
                ok: true,
                requestId: reinserted[0].id,
                resent: true
            });
        }
        if (e.status === "declined") {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$social$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiJson"])({
                error: "Пользователь отклонил твою заявку ранее"
            }, {
                status: 400
            });
        }
        // Встречная pending-заявка от получателя: принимаем её — вы оба хотели дружить.
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].update(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"]).set({
            status: "accepted"
        }).where(eq(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"].id, e.id));
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$social$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiJson"])({
            ok: true,
            autoAccepted: true
        });
    }
    const inserted = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].insert(__TURBOPACK__imported__module__$5b$project$5d2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["friendRequests"]).values({
        fromId: me.id,
        toId,
        status: "pending"
    }).returning();
...
//# sourceMappingURL=%5Broot-of-the-server%5D__10.uyvb._.js.map