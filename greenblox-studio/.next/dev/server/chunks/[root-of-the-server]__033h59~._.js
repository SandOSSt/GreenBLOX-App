...
"[project]/greenblox-studio/src/app/api/sessions/sync/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(req) {
    ...
    const avatarColors = rawColors && [
        ...
        "rightLeg",
        "shirt"
    ].every((k)=>typeof rawColors[k] === "string" && /^#[0-9a-fA-F]{6}$/.test(rawColors[k])) ? {
        head: rawColors.head,
    ...
    const players = __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$socialStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["socialStore"].syncFull({
        id: me.id,
        name: me.name,
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$socialStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["socialStore"].ping({
        id: me.id,
        name: me.name,
        avatarColor: me.avatarColor
    }, "in_game");
...
//# sourceMappingURL=%5Broot-of-the-server%5D__033h59~._.js.map