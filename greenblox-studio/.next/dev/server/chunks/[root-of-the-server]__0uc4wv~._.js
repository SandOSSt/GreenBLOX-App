...
"[project]/greenblox-studio/src/app/api/sessions/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
[__TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$accountHelpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__, __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__] = __turbopack_async_dependencies__.then ? (await __turbopack_async_dependencies__)() : __turbopack_async_dependencies__;
;
;
;
;
...
function isCatalogPlace(placeId) {
...
async function POST(req) {
    ...
    if (code) {
        const session = __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$socialStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["socialStore"].joinSession({
            id: me.id,
            name: me.name,
            avatarColor: me.avatarColor
        }, code);
        if (session === null) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiJson"])({
            error: "Сессия не найдена"
        }, {
            status: 404
        });
        if (session === "full") return (0, __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiJson"])({
            error: "Сессия заполнена"
        }, {
            status: 409
        });
        return (0, __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiJson"])({
            session: __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$socialStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["socialStore"].serializeSession(session),
            joined: true
        });
    }
    const placeId = String(body.placeId ?? "").trim();
    if (!placeId) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiJson"])({
        error: "placeId обязателен"
    }, {
        status: 400
    });
    ...
    if (isCatalogPlace(placeId)) {
        ...
        if (!Number.isInteger(numeric) || numeric <= 0) {
            return (0, __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiJson"])({
                error: "Некорректный placeId"
            }, {
                status: 400
            });
        }
        const project = await __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$db$2f$index$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].select().from(__TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["projects"]).where((0, __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$node_modules$2f$drizzle$2d$orm$2f$sql$2f$expressions$2f$conditions$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["eq"])(__TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$db$2f$schema$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["projects"].id, numeric)).limit(1);
        if (project.length === 0) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiJson"])({
            error: "Плейс не найден"
        }, {
            status: 404
        });
        placeTitle = project[0].title;
    }
    const session = __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$socialStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["socialStore"].createSession({
        id: me.id,
        name: me.name,
        avatarColor: me.avatarColor
    }, {
...
async function GET(req) {
    ...
    if (!code) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiJson"])({
        error: "code обязателен"
    }, {
        status: 400
    });
    const session = __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$socialStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["socialStore"].getSessionByCode(code);
    if (!session) return (0, __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiJson"])({
        error: "Сессия не найдена"
    }, {
        status: 404
    });
...
async function DELETE(req) {
    ...
    __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$socialStore$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["socialStore"].leaveSession(me.id, id);
    return (0, __TURBOPACK__imported__module__$5b$project$5d2f$greenblox$2d$studio$2f$src$2f$social$2f$helpers$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["apiJson"])({
        ok: true
    });
}
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0uc4wv~._.js.map